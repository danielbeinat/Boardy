...
import { AuthModal, LandingPage } from "./components/features";
...
export const App: React.FC = () => {
  ...
  const { board, addList, updateList, deleteList, copyList, addCard, updateCard, deleteCard, moveCard } = useBoardStore();
